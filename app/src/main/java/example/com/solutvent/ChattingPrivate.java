...
public class ChattingPrivate extends AppCompatActivity {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!msg.equals("")){
                    ...
                    Toast.makeText(ChattingPrivate.this, "You can't send empty messages", Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
                                    ...
                                    .enqueue(new Callback<MyResponse>() {
                                        ...
                                        public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                                            if(response.body().success != 1){
                                                Toast.makeText(ChattingPrivate.this, "Failed to send notification", Toast.LENGTH_SHORT).show();
                                            }
                                        }
        ...
        table_chat.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot data : dataSnapshot.getChildren()){
                    ...
                    chatAdapter = new ChatAdapter(ChattingPrivate.this, mchats);
